...
import {AiOutlineFacebook, AiOutlineLinkedin, AiOutlinePhone, AiOutlineWhatsApp} from 'react-icons/ai'
...
const Header = () => {
  return (
    ...
    <div className="flex flex-wrap inline justify-between items-center mx-auto max-w-screen-xl p-4">
      <div className='flex flex-inline font-bold'>
        <a href='tel:+34 918281264' className="flex flex-inline">
            <AiOutlinePhone className='h-6'/>
            &nbsp;91 828 12 64&nbsp;&nbsp;
        </a>
        <a href="https://api.whatsapp.com/send?phone=672226122" className="flex items-center">
            <AiOutlineWhatsApp />
            &nbsp;672 226 122
        </a>
        </div>
        <div className="flex items-center">
        <a href="https://api.whatsapp.com/send?phone=672226122" className="flex items-center px-4 border-l">
